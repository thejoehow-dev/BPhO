...
- Download the first .zip file from our latest [release](https://github.com/thejoehow-dev/BPhO/releases)
...
OR
<br></br>
- To make running individual tasks easier you can download individual tasks from the [standalone code folder](https://github.com/thejoehow-dev/BPhO/tree/main/standalone%20code). The files in this folder are designed to run on their own, e.g. without use of image files or a main menu.
