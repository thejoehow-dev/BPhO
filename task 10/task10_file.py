...
A_var = ctk.StringVar(value=str(A))
...
n_var = ctk.StringVar(value=str(n))
...
plane_var = ctk.StringVar(value="z-plane")
...
y_plane = 0
z_plane = 0
x_plane_var = ctk.DoubleVar(value=0)
y_plane_var = ctk.DoubleVar(value=0)
z_plane_var = ctk.DoubleVar(value=0)
...
resol_var = ctk.StringVar(value="500")
...
interp_var = ctk.StringVar(value="100")
...
normalise_mode = ctk.StringVar(value="Global")
...
threshold_var = ctk.StringVar(value="0.15")
...
lines_number_var = ctk.StringVar(value="10")
...
contour_color_mode = ctk.StringVar(value="Greyscale")
...
contour_background_mode = ctk.StringVar(value="Plane Slice")
...
find_contour_var = ctk.StringVar(value="0.00")
...
height_scale_var = ctk.DoubleVar(value=1.0)
height_max_var = ctk.StringVar(value="5")
...
mayavi_resol_var = ctk.StringVar(value="120")
...
mayavi_layers_var = ctk.StringVar(value="100")
